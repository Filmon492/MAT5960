...
$u_{\epsilon}$ of \eqref{eq:nonlocal_model} converge to a solution of \eqref{eq:local model}, is the key question that has been studied in the literature (need a citation).
...
Detailed characteristics of the entropy solution can be found in \cite{Ulrik2015_entropy}.
